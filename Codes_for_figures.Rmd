...
```{r}
pdf(paste0("../",outfolder,"/SpeciesStates_corplot.pdf"), 
    onefile = TRUE)
par(mfrow=c(2,2))
ncut = 60
...
```{r}
stateSlopes = read.csv("/Users/feiz/Documents/Box Sync/Horvath/Mammalian meth projects/Slope/MainFigures/stateSlopes_IdentityScaled.csv",
                       row.names = 1)
